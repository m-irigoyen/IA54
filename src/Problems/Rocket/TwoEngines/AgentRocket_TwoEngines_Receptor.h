...
public:
	AgentRocket_TwoEngines_Receptor(ProblemRocket_TwoEngines* problem, BodyReceptor_Composition* body = NULL, AGENTTYPE_ROCKET_TWO type = AGENTTYPE_ROCKET_TWO::ROCKET_HS_TWO_DEFAULT);
